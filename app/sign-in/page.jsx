...
const SignIn = () => {
  return (
   <div>
     <Navbar/>
        <div className='flex justify-center flex-col items-center py-64'>
            <div className='uppercase mb-16 font-black text-[24px] gap-2 flex justify-center items-center sm:flex-row border-2 border-[#fff] rounded-2xl py-1 px-2'>
                <h1>Sign in with Google</h1>
                <svg className='w-[50px] invert' xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
